...
loadCSV("temp.csv"); // Download the CSV data, load Google Charts, parse the data, and draw the chart
...
document.getElementById("refresh").onclick = function() {
    viewportEndTime = new Date(); // the end time of the viewport is the current time
    loadCSV("temp.csv"); // download the latest data and re-draw the chart
}
